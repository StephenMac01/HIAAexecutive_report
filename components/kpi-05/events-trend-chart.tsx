      ...
      <CardContent>
        <ChartContainer config={chartConfig} className="h-72 w-full">
          <BarChart data={data} margin={{ top: 8, right: 8, left: -12, bottom: 0 }}>
            ...
            <Bar isAnimationActive={false} dataKey="untrained" stackId="a" fill="var(--color-untrained)" radius={[0, 0, 0, 0]} />
            <Bar isAnimationActive={false} dataKey="unqualified" stackId="a" fill="var(--color-unqualified)" radius={[4, 4, 0, 0]} />
          </BarChart>
        </ChartContainer>
      </CardContent>
    </Card>
