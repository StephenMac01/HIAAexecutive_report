        ...
        <CardContent>
          ...
          >
            <PieChart>
              ...
              <Pie isAnimationActive={false} data={statusBreakdown} dataKey="count" nameKey="status" innerRadius={55} strokeWidth={2}>
        ...
        <CardContent>
          ...
          >
            <BarChart data={eventsByCategory} layout="vertical" margin={{ left: 12, right: 16 }}>
              ...
              />
              <ChartTooltip content={<ChartTooltipContent />} />
              <Bar isAnimationActive={false} dataKey="events" fill="var(--color-events)" radius={[0, 4, 4, 0]} barSize={22} />
            </BarChart>
          </ChartContainer>
        </CardContent>
      </Card>
