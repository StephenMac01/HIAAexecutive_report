...
const chartConfig = {
  total: { label: "Records" },
  "HIAA Annual Report": { label: "HIAA Annual Report", color: "var(--chart-1)" },
  "Public Complaint": { label: "Public Complaint", color: "var(--chart-4)" },
  "Operational Report": { label: "Operational Report", color: "var(--chart-5)" },
  ...
  return (
    <Card className="flex flex-col">
      <CardHeader>
        ...
        <CardDescription>Origin of the reported events under review</CardDescription>
      </CardHeader>
      <CardContent className="flex-1">
        ...
        >
          <PieChart>
            ...
            <ChartLegend content={<ChartLegendContent nameKey="source" />} className="flex-wrap" />
          </PieChart>
        </ChartContainer>
      </CardContent>
    </Card>
