      ...
      <div className="h-64 w-full">
        <ResponsiveChart>
          <BarChart data={data} barGap={4} margin={{ top: 8, right: 8, left: -16, bottom: 0 }}>
            ...
            />
            <Bar isAnimationActive={false} dataKey="approved" name="Approved" radius={[4, 4, 0, 0]} fill="var(--chart-1)" />
            <Bar isAnimationActive={false} dataKey="unauthorized" name="Unauthorized" radius={[4, 4, 0, 0]}>
              {data.map((_, i) => (
