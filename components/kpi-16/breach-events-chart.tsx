      ...
      <CardContent className="flex-1">
        <ChartContainer config={chartConfig} className="h-[280px] w-full">
          <BarChart data={monthlySummary} margin={{ top: 8, right: 12, left: 4, bottom: 4 }}>
            ...
            <Bar dataKey="emergencyBreaches" fill="var(--color-emergencyBreaches)" radius={[4, 4, 0, 0]} />
            <Bar dataKey="nonEmergencyBreaches" fill="var(--color-nonEmergencyBreaches)" radius={[4, 4, 0, 0]} />
          </BarChart>
        </ChartContainer>
      </CardContent>
    </Card>
